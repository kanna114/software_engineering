...
import app.reservation.ReserveCancelControl;
import app.reservation.ReserveCancelForm;
...
public class CUI {
	...
	private void cancelRes() throws IOException, AppException {
		System.out.println("Input reservation number");
		System.out.print("> ");

		String resvNum = reader.readLine();

		// Validate input


		ReserveCancelForm reserveCancelForm = new ReserveCancelForm();
		reserveCancelForm.setResvNum(resvNum);
		int cancelState = reserveCancelForm.cancelReservation();
		if(cancelState == 0) {
			System.out.println("Reservation has been cancelled.");
			System.out.println("Reservation number is " + resvNum + ".");
		}
	}
